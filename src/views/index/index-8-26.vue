...
export default {
      ...
      toolbars: [
        {
          ...
          radio: { name: "radioxx", checked: true }
        },
        {
          name: "radio2",
          icon: "el-icon-circle-plus",
        ...
        { name: "新增表", icon: "el-icon-circle-plus", fun: this.addTableFun },
        {
          name: "删除表1",
          icon: "el-icon-circle-plus",
          fun: this.delTable1Fun
        },
        {
          name: "删除表2",
          icon: "el-icon-circle-plus",
          fun: this.delTable2Fun
        },
        {
          name: "切换合闭表1",
          icon: "el-icon-circle-plus",
          fun: this.collapse1Fun
        },
        {
          name: "增加表1的1列",
          icon: "el-icon-circle-plus",
          fun: this.addTableOneRowFun
        },
        {
          name: "删除表1的1列",
          icon: "el-icon-circle-plus",
          fun: this.delTableOneRowFun
        },
        {
          name: "删除表1的1列1线",
          icon: "el-icon-circle-plus",
          fun: this.delTableOneRowOneToFun
        },
        {
          name: "获取选中",
          icon: "el-icon-circle-plus",
          fun: this.getSelectionCellsFun
        },
        {
          name: "切换图标",
          icon: "el-icon-circle-plus",
          fun: this.toggleIconFun
        }
      ],
      // tableArr: []
      tableArr: [
  ...
  methods: {
    ...
    checkChangeFun(data) {
      console.log(data);
      this.tableArr[0].children.find(
        t => t.fieldId === data.fieldId
      ).selected = false;
    }
  }
};
